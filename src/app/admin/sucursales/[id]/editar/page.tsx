...
async function updateBranch(formData: FormData) {
  ...
  if (!id || !name || !city || !state || !address) {
    throw new Error("Faltan campos obligatorios para actualizar la sucursal.");
  }
      ...
      <section className="bg-[var(--rise-navy)] py-12 text-white">
        <Container>
          ...
          <p className="mt-4 max-w-2xl text-sm leading-6 text-slate-300">
            Actualiza la información de contacto, ubicación, servicios y estado
            de la sucursal.
          </p>
        </Container>
      </section>
              ...
              <div className="rounded-[2rem] border border-[var(--rise-border)] bg-white p-6 shadow-xl shadow-slate-900/5">
                ...
                <div className="mt-6 rounded-2xl bg-[var(--rise-blue-soft)] p-4">
                  <p className="text-xs leading-5 text-slate-600">
                    Las sucursales desactivadas pueden conservarse en base de
                    datos, pero se ocultarán en la vista pública cuando la
                    conectemos.
                  </p>
                </div>
              </div>
